<?php  
//ako nije logovan korisnik da ga vrati na log in
...
<div id="pregled" class="panel panel-success" style="margin-top: 1%;">
    ...
    <div class="panel-body">
        <table id="myTable" class="table table-hover table-striped" style="color: black; background-color: grey;" >
            ...
            <tbody>
                <?php while($red =$podaci->fetch_array () ):?> // vraca podatke red po red iy upita eslect *from prijave
                <tr>
                ...
                <?php endwhile; }?> // OVDE SMO ATVROILI ELSE GRANU IZ GOERNJEG IF-Aa i while petlja
            </tbody>
        </table>
        <div class="row" >
